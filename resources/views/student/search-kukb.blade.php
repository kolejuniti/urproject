            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-8">
                    ...
                    <div class="card card-theme mb-4 text-center p-5">
                        ...
                        <div>
                            <a href="{{ route('semak.permohonan.kukb') }}" class="btn btn-outline-secondary rounded-pill px-4">
                                <i class="bi bi-arrow-left me-2"></i> Cuba Semula
                            </a>
                            <a href="{{ route('student.register-kukb') }}" class="btn btn-primary-custom ms-2">
                    ...
                    <div class="card card-theme printableArea mb-5">
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            <!-- Form Kemaskini -->
                            <form action="{{ route('kemaskini.permohonan.kukb', [$student->ic, $student->email]) }}" method="POST" enctype="multipart/form-data" class="bg-light p-4 rounded-3 border mb-4 no-print">
                                @csrf
                                @method('PUT')
                        ...
                        <div class="card-footer bg-white text-center border-top-0 pb-4 pt-0">
                            ...
                            <a href="{{ route('semak.permohonan.kukb') }}" class="btn btn-link text-decoration-none text-muted ms-2">Kembali</a>
                        </div>
                    </div>
                    @endforeach
                    @endif
