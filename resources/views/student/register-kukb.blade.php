...
@section('title', 'Daftar | Kolej UNITI Kota Bharu')   
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 col-sm-12">
            ...
            @endif
            <div class="card">
                <div class="card-header">{{ __('Borang Pendaftaran | Kolej UNITI Kota Bharu') }}</div>
                <form action="{{ route('student.register-kukb.post') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                <div class="card-body bg-white">
                    ...
                    <div class="mb-2">
                        <div class="col-md-6 col-sm-6 form-floating">
                            <input type="text" id="location" name="location" value="KOLEJ UNITI KOTA BHARU" class="form-control form-control-sm" readonly>
