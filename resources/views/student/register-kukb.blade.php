...
<head>
    ...
    <title>Daftar | Kolej UNITI Kota Bharu</title>

    <!-- Meta -->
    <meta name="description" content="Daftar Pengajian di Kolej UNITI Kota Bharu. Diploma diiktiraf MQA.">
...
<body>
    ...
    <div class="register-container">
        ...
        <div class="register-card">
            <div class="card-header-custom">
                ...
                <p class="mb-0 text-white-50">Kolej UNITI Kota Bharu</p>
            </div>

            <form action="{{ route('student.register-kukb.post') }}" method="POST" enctype="multipart/form-data" class="needs-validation p-4 p-md-5" novalidate>
                @csrf
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6 form-floating">
                        <input type="text" id="location" name="location" value="KOLEJ UNITI KOTA BHARU" class="form-control" readonly>
    ...
    <footer>
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-5">
                    <!-- <img src="https://ku-storage-object.ap-south-1.linodeobjects.com/urproject/img/ku1.png" alt="Logo" class="mb-3" style="height:60px; filter: brightness(0) invert(1);"> -->
                ...
                <div class="col-lg-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="{{ route('student.kukb') . (isset($source) ? '?source=' . $source : '') . (isset($ref) ? (isset($source) ? '&' : '?') . 'ref=' . $ref : '') }}#programmes">Program</a></li>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="d-flex gap-3 mt-3">
                        ...
                        <a href="https://facebook.com/kolejunitikotabharu" class="social-link" target="_blank"><i class="bi bi-facebook"></i></a>
