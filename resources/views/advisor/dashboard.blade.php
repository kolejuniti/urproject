    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header" style="background-color: #e65100; color: white; font-weight: bold;">Jumlah Pemohon (3 Bulan Terakhir)</div>
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header" style="background-color: #e65100; color: white; font-weight: bold;">Permohonan Yang Diterima/Diagihkan</div>
                <div class="card-body" style="background-color: #fff3e0;">
                    <div class="row text-center">
                        <div class="col-md-4 mb-2">
                            <div class="bg-light border rounded p-3 shadow-sm">
